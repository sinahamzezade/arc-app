# 11 — Weekly Leagues & Leaderboards
...
**Depends on:** `../gamification/07-gamification.md`, `../ranks/10-ranking-system.md`, `../social/12-social-media.md`, `../notifications/06-notifications.md`
