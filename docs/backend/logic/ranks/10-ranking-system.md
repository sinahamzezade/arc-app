...
**Depends on:** `../gamification/07-gamification.md`, `../roadmaps/03-goals-and-roadmap.md`, `../weeks/04-weekly-plan-and-lessons.md`, `../notifications/06-notifications.md`
