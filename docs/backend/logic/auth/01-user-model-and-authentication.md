...
**Integration:** Follow [00 — System Integration Contract](../integration/00-system-integration.md). Profile economy/rank/streak fields in this document are compatibility mirrors; their canonical owners are Gamification and Ranking.
...
- Reward/wallet mutation is owned by `../gamification/07-gamification.md`
- Friends/social graph is owned by `../social/12-social-media.md`
