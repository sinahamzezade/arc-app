...
**Depends on:** [00 — System Integration Contract](../integration/00-system-integration.md), [Gamification](../gamification/07-gamification.md), [Ranking](../ranks/10-ranking-system.md), [Leagues](../leagues/11-leagues.md), [Lessons](../lessons/05-learn-lesson-play-api.md), [Weekly Plan](../weeks/04-weekly-plan-and-lessons.md), [Notifications](../notifications/06-notifications.md)  
**Integrates with:** [Social Media](../social/12-social-media.md), [Battle Mode](../battles/14-battle-mode.md), [Study Together](../study-together/13-study-together.md), [Lucky Wheel](../lucky-wheel/15-lucky-wheel.md), [Referral System](../referrals/21-referral-system.md), [Content Pool](../content-pool/08-content-pool.md)
...
Ranks may require specific earned badges as proof, but rank remains owned by `../ranks/10-ranking-system.md`.
