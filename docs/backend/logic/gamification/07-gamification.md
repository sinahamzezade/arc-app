# 07 — Gamification, Economy, Store, Unlocks & Streaks
...
**Depends on:** `../weeks/04-weekly-plan-and-lessons.md`, `../lessons/05-learn-lesson-play-api.md`, `../notifications/06-notifications.md`  
**Feeds:** `../ranks/10-ranking-system.md`, `../leagues/11-leagues.md`, `../lucky-wheel/15-lucky-wheel.md`, `../battles/14-battle-mode.md`
...
| Doc area | Code |
|----------|------|
| Module | `arc-backend/src/gamification/` |
