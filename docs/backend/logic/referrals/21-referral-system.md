...
**Depends on:** [00 — System Integration Contract](../integration/00-system-integration.md), [01 — User Model & Authentication](../auth/01-user-model-and-authentication.md), [Gamification](../gamification/07-gamification.md), [Notifications](../notifications/06-notifications.md)  
**Integrates with:** [Social Media](../social/12-social-media.md), [Ranking](../ranks/10-ranking-system.md), [Leagues](../leagues/11-leagues.md)
