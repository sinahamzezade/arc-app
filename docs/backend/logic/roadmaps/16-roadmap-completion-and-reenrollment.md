# 16 — Roadmap Completion & Re-enrollment

**Version:** 1.0
**Stack:** NestJS + TypeORM + PostgreSQL
**Consumers:** Arc Next.js PWA (`arc-app`)
**Depends on:** [00](../integration/00-system-integration.md), [02](../questionnaire/02-questionnaire.md), [03](./03-goals-and-roadmap.md), [05](../lessons/05-learn-lesson-play-api.md), [07 — Gamification](../gamification/07-gamification.md)
**Feeds:** [03](./03-goals-and-roadmap.md) (new roadmap generation), [02](../questionnaire/02-questionnaire.md) (re-enrollment), [07 — Gamification](../gamification/07-gamification.md) (graduation rewards)
