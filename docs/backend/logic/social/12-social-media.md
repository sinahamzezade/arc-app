# 12 — Social Media, Friends & Following
...
**Depends on:** `../auth/01-user-model-and-authentication.md`, `../notifications/06-notifications.md`  
**Feeds:** `../battles/14-battle-mode.md`, `../study-together/13-study-together.md`, `../leagues/11-leagues.md`
...
- Battle match logic — `../battles/14-battle-mode.md`
- shared study room logic — `../study-together/13-study-together.md`
- rewards — `../gamification/07-gamification.md`
- league scoring — `../leagues/11-leagues.md`
