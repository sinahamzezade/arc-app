...
**Depends on:** [00](./00-system-integration.md), [01](./01-user-model-and-authentication.md)
...
- `src/notifications/entities/*` — prefs, inbox, devices, schedules, deliveries
- `src/notifications/notifications.service.ts` — dedupe, quiet hours, caps, allowlist, outbox fan-in
- `src/notifications/notifications.controller.ts` — cursor list, delete, devices, prefs
- `src/gamification/gamification.service.ts` — `processPendingOutbox` → notifications
